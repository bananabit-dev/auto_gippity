...
mod tests {
    ...
    async fn tests_solution_architect() {
        ...
        let mut factsheet : FactSheet =FactSheet { project_description:"Build a fullstack website with user login and logout that shows latest forex prices.".to_string(), project_scope: None, external_urls: None, backend_code: None, api_endpoint_schema: None };
        dbg!(&agent);    
