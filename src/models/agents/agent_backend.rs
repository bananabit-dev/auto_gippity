...
use crate::helpers::command_line::{ai_task_request, confirm_safe_code, PrintCommand};
...
impl AgentBackendDeveloper {
    ...
    async fn call_initial_backend_code(&mut self, factsheet: &mut FactSheet) {
        let code_template_str: String = read_code_template_contents().await;
    ...
    async fn call_extract_rest_api_endpoints(&self) -> String {
        let backend_code: String = read_exec_main_contents().await;
            ...
            match &self.attributes.state {
                ...
                AgentState::UnitTesting => {
                    ...
                    */
                    ...
                    save_api_endpoint(&api_endpoints_str).await;
